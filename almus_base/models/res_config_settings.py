...
class ResConfigSettings(models.TransientModel):
    ...
    def _compute_almus_stats(self):
        ...
        for settings in self:
            ...
            # Log para debug
            _logger.info("Módulos Almus encontrados: %s", almus_modules.mapped('name'))
            ...
            if almus_modules:
                ...
                for module in almus_modules.sorted('name'):
                    ...
                    # Determinar el icono
                    icon_path = f'/{module.name}/static/description/icon.png'
                    # Si no existe icono personalizado, usar uno genérico
                    default_icon = '/base/static/description/icon.png'
                    
                    app_html += f'''
                    <div class="col-md-6 mb-3">
                        <div class="d-flex align-items-center">
                            <img src="{icon_path}" alt="{display_name}" 
                                 style="width: 32px; height: 32px; margin-right: 12px; object-fit: contain;"
        ...
        for settings in self:
            ...
            if almus_modules:
                ...
                for module in almus_modules.sorted('name'):
                    ...
                    # Determinar el icono
                    icon_path = f'/almus_{module.name.replace("almus_", "")}/static/description/icon.png'
                    # Si no existe icono personalizado, usar uno genérico
                    default_icon = '/base/static/description/icon.png'
